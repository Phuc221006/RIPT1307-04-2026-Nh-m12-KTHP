...
import * as Plugin_0 from 'C:/web_ts_dai_hoc/RIPT1307-04-2026-Nh-m12-KTHP/frontend/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/web_ts_dai_hoc/RIPT1307-04-2026-Nh-m12-KTHP/frontend/src/app.tsx',
    },
    {
      apply: Plugin_1,
